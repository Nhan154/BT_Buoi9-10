...
const employeeManager = {
  ...
  validateForm: function () {
      ...
      if (!matKhau) {
          ...
          $("#tbMatKhau").text("Mật khẩu 6-10 ký tự, có ít nhất 1 số, 1 hoa, 1 đặc biệt").css("color", "red");
          isValid = false;
      }
      ...
      if (!luongCB) {
          ...
          $("#tbLuongCB").text("Lương cơ bản phải từ 1,000,000 đến 20,000,000").css("color", "red");
          isValid = false;
      }
      ...
      if (!gioLam) {
          ...
          $("#tbGiolam").text("Giờ làm phải từ 80 đến 200 giờ").css("color", "red");
          isValid = false;
      }
  ...
  loadFromLocalStorage: function () {
      ...
      if (data) {
          ...
          this.danhSachNV = arr.map(nv => new NhanVien(
              nv.taiKhoan,
              nv.hoTen,
              nv.email,
              nv.matKhau,
